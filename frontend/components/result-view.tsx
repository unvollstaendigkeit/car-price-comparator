  ...
  if (!car) {
    return (
      <div className="flex flex-col items-start gap-3 rounded-lg border border-border bg-surface px-5 py-6">
        <p className="text-[15px] text-foreground">Missing car details in this link.</p>
        <p className="text-[13px] text-muted">
          This page expects the car&apos;s details in the URL. Go back and submit the form again.
        </p>
